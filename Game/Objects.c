...
GameObj* AllGameObjects(GameObj* list, int numObjects) {
	list = (GameObj *)malloc(numObjects * sizeof(GameObj));
	return list;
}
GameObjInst* AllGameObjectInsts(GameObjInst* list, int numInsts) {
	list = (GameObjInst *)malloc(numInsts * sizeof(GameObjInst));
	return list;
}
...
void make_object(float x, float y, int color) {
