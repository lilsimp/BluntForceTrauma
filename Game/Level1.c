...
static void make_object(float x, float y, int color) {
	AEGfxMeshStart();
...
static void make_circle_object(int parts, int color) {
	AEGfxMeshStart();
...
static void make_triangle_object(float x, float y, int color) {
	AEGfxMeshStart();
...
void Level1_Load(void) {
  ...
  /* MAKING PARTICLES NOW */
	...
	make_object(0.5f, 0.5f, 0xFF0000FF, TYPE_OBJECT_PLAYER_BITS;
	pObj->pMesh = AEGfxMeshEnd();
